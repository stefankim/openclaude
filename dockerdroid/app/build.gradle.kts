...
android {
    ...
    defaultConfig {
        applicationId = "com.dockerdroid.app"
        ...
        // DockerDroid only ships ARM64 native tooling; constrain the ABI so the
        // bundled installer never advertises an unsupported architecture.
        ndk {
...
dependencies {
    ...
    // Docker Engine HTTP API over the unix socket
